...
struct WASMPlugin {
    ...
    static ErrorOr<WASMPlugin> create(WASMPluginManager* manager, StringView path);
...
private:
    WASMPlugin(WASMPluginManager* manager, Core::MappedFile&& file, StringBuffer&& name, IM3Environment env, IM3Runtime runtime, IM3Module mod);
};
