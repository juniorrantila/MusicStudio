...
typedef struct ByteDecoder {
    ...
    ByteFound peek_string(u64 count, StringView2*) const;
    ...
    ByteFound parse_string(u64 count, StringView2*);
...
C_API ByteFound byte_peek_string(ByteDecoder const*, u64 count, StringView2*);
...
C_API ByteExpect byte_expect_string(ByteDecoder*, StringView2 value);
...
C_API ByteFound byte_parse_string(ByteDecoder*, u64 count, StringView2*);
