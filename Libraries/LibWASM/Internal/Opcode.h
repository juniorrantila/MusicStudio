 ...
 * Copyright (c) 2025, Junior Rantila <junior.rantila@gmail.com>
 *
...
/// https://webassembly.github.io/spec/core/_download/WebAssembly.pdf#subsection.5.4.6
...
// These are synthetic multibyte opcodes, they are _not_ seen in wasm with these values.
...
typedef enum WASMOpcode : u64 {
#define M(name, value) WASMOpcode_##name = value,
    ENUMERATE_WASM_OPCODES(M)
#undef M
    WASMOpcode_Invalid = 0xFFFFFFFFFFFFFFFF,
} WASMOpcode;

C_API c_string wasm_opcode_string(WASMOpcode);
